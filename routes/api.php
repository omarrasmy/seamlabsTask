...
Route::get('tasks',[TaskController::class,'getCountOfTwoNumber']);
Route::post('tasks',[TaskController::class,'getLetastSteps']);
Route::get('tasks/alphabetics',[TaskController::class,'getCountOfalphabetics']);
