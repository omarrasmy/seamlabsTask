...
class LoginController extends Controller
{
     ...
     *         @OA\JsonContent(ref="#/components/schemas/UsersLoginResponse"),
     *     ),
     *      @OA\Response(
     *          response=422,
    ...
    {
        $remember=$request->get('remember')?$request->get('remember'):true;
        $token = $this->guard()->attempt($this->credentials($request),$remember);
